<!-- ccsop:begin — managed block; edit outside this block only. /sop-init appends it once;
     /sop-update refreshes ONLY this block. -->
## Project delivery SOP (ccsop)
...
3. Rules source of truth: `docs/methodology/` (`project-delivery-sop.md`,
   `claude-code-sop-collaboration.md` §1.D flow matrix, `workflow-overview.md`).
4. Before implement / fix, read the full task card in `docs/plans/active/`.
<!-- ccsop:end -->
