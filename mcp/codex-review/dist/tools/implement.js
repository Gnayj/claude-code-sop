...
export const implementToolSchema = {
    ...
    description: "Dispatch one bounded implement work order to a codex writer (claude+codex preside flow, " +
...
export async function handleImplement(deps, rawInput, signal) {
