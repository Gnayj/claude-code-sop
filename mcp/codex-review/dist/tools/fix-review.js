...
import { FixReviewInput } from "../types.js";
...
export const fixReviewToolSchema = {
    ...
    description: "Run a Codex fix-review against previous-round Critical/Important conclusions. " +
...
export async function handleFixReview(deps, rawInput) {
    const input = FixReviewInput.parse(rawInput);
    const fileBlocks = [
    ...
    return runReviewFlow(deps, {
        ...
        promptVars: {
            ...
            previous_round_conclusions_json: JSON.stringify(input.previous_round_conclusions, null, 2),
