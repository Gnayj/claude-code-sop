...
import { DesignReviewInput } from "../types.js";
...
export const designReviewToolSchema = {
    ...
    description: "Run a Codex design pre-review. ONLY call when claude-code-sop-collaboration.md §4.5 trigger conditions are hit.",
    inputSchema: {
        type: "object",
        properties: {
...
export async function handleDesignReview(deps, rawInput) {
    const input = DesignReviewInput.parse(rawInput);
    const fileBlocks = [
    ...
    return runReviewFlow(deps, {
        ...
        hasPreviousRoundResolved: Array.isArray(input.previous_round_resolved) &&
