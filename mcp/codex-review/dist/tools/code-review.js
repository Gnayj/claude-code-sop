...
import { CodeReviewInput } from "../types.js";
...
export const codeReviewToolSchema = {
    ...
    description: "Run a Codex code review on the implement diff. Verdict ∈ {Pass, Pass-after-fixes, Rereview-after-fixes, No-Go}.",
    inputSchema: {
        type: "object",
        properties: {
...
export async function handleCodeReview(deps, rawInput) {
    const input = CodeReviewInput.parse(rawInput);
    const fileBlocks = [
